...
import { getMediaPosts, getOtherUserMediaPosts } from "../actions/getMediaPosts"
...
export default async function TabMedia({ userId }: { userId: string }) {
  const user = await currentUser();
  const posts = await getOtherUserMediaPosts(userId);
