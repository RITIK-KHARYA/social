...
import { getCurrentUserPost, getOtherUserPost } from "../actions/getCurrentUserPost"
...
export default async function TabPost({userId}: {userId: string}) {
    const user = await currentUser();
    const posts= await getOtherUserPost(userId)
