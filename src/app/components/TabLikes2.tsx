...
import { getLikes, getOtherUserLikes } from "../actions/getLikes"
...
export default async function TabLikes({ userId }: { userId: string }) {
  const user = await currentUser();
  const posts = await getOtherUserLikes(userId);
